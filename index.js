...
client.once('ready', () => {
  ...
  client.user.setActivity(`${config.prefix}gen │ pry${config.servername}`, { type: "STREAMING", url: "https://www.youtube.com/watch?v=dQw4w9WgXcQ" }); // Set the bot's activity status
